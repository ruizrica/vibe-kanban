...
fn generate_types_content() -> String {
    ...
    let decls = [
        ...
        vibe_kanban::models::task_spec::TaskSpecStatus::decl(),
        vibe_kanban::models::task_spec::UserStory::decl(),
        vibe_kanban::models::task_spec::TaskSpec::decl(),
        vibe_kanban::models::task_spec::CreateTaskSpec::decl(),
        vibe_kanban::models::task_spec::UpdateTaskSpec::decl(),
        vibe_kanban::models::task_spec::UpdateTaskSpecStatus::decl(),
